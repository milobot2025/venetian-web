...
export interface ApiConfiguracionDelSitioConfiguracionDelSitio
  extends Struct.SingleTypeSchema {
  collectionName: 'configuracion_del_sitio';
  info: {
    description: '';
    displayName: 'Configuraci\u00F3n del sitio';
    pluralName: 'configuracion-del-sitios';
    singularName: 'configuracion-del-sitio';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::configuracion-del-sitio.configuracion-del-sitio'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::configuracion-del-sitio.configuracion-del-sitio': ApiConfiguracionDelSitioConfiguracionDelSitio;
